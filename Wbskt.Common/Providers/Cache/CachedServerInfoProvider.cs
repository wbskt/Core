...
{
    internal sealed class CachedServerInfoProvider(ILogger<CachedServerInfoProvider> logger, ServerInfoProvider serverInfoProvider) : ICachedServerInfoProvider
    {
